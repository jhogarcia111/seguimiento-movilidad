...
export default function PendingApprovalPage() {
  ...
  const [greetingVideo] = useState(() => getRandomVideo('welcome'));
            ...
            onLoadedData={() => {
              if (videoRef.current) {
                ...
                videoRef.current.play().catch((error) => {
                  console.log(
                    'Error al reproducir con sonido, intentando sin sonido:',
                    error
                  );
            ...
            <div className="pending-message">
              ...
              <div className="pending-benefits-section">
                ...
                <p className="pending-intro-text">
                  Soy <strong>Tito</strong>, tu asistente virtual para el seguimiento de movilidad
                  en Bogotá. Una vez que tu cuenta sea aprobada, podrás disfrutar de:
                </p>
                <ul className="pending-benefits-list">
                  <li className="pending-benefit-item">
                    <span className="benefit-icon">🔍</span>
                    <span>
                      <strong>Búsqueda por Sector:</strong> Encuentra problemas de movilidad en
                      cualquier zona de Bogotá
                    </span>
                  </li>
                  <li className="pending-benefit-item">
                    <span className="benefit-icon">⏱️</span>
                    <span>
                      <strong>Información en Tiempo Real:</strong> Datos actualizados cada 30
                      minutos
                    </span>
                  </li>
                  <li className="pending-benefit-item">
                    <span className="benefit-icon">📱</span>
                    <span>
                      <strong>Historial de Búsquedas:</strong> Guarda tus consultas anteriores
                    </span>
                  </li>
                  <li className="pending-benefit-item">
                    <span className="benefit-icon">🚦</span>
                    <span>
                      <strong>Asistente Personal:</strong> Te guiaré en cada paso de tu
                      experiencia
                    </span>
                  </li>
                </ul>
              ...
              <div className="pending-wait-message">
                <p className="pending-message-text">
                  Por favor, espera a que nuestro equipo valide tu solicitud. Te notificaremos
                  por email cuando tu cuenta esté lista.
                </p>
              </div>
            </div>
